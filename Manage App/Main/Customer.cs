...
namespace Manage_App
{
    public partial class Customer : UserControl
    {
        ...
        public static Customer Ins { get { if (ins == null) ins = new Customer(); return ins; } private set => ins = value; }
        ...
        {
            dgv_KhachHang.DataSource = KhachHang_DAO.Ins.GetCustomer();
        }
